#!/usr/bin/env python3
"""
WebSight Dataset Fetcher for Qwen Series format.
...
Output structure:
    output/qwen_series/websight_v01/  (or websight_v02/)
        images/
            websight_000000.png, websight_000001.png, ...
        meta_data_websight.json
        meta_data_websight_100k.json
...
class WebSightFetcher:
    """Fetches WebSight dataset and exports to Qwen Series format."""
...
Do not include markdown "```" or "```html" at the start or end."""
    ...
    def __init__(
        ...
        """
        Initialize the WebSight fetcher.

        Args:
            output_dir: Base output directory (e.g., './output')
            version: Dataset version ('v0.1' or 'v0.2')
    ...
    def _process_sample(
        ...
        # Extract fields - WebSight uses 'image' and 'text' fields
    ...
    def _print_summary(self) -> None:
        ...
        print("\n" + "=" * 60)
        print(f"WebSight Export Complete ({self.version}, Qwen Series Format)")
        print("=" * 60)
    ...
    def run(
        ...
        logger.info(f"WebSight Dataset Fetcher (Qwen Series Format)")
...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Fetch WebSight dataset and export to Qwen Series format",
...
Output structure:
  {output}/qwen_series/websight_v02/  (or websight_v01/)
      images/websight_000000.png, websight_000001.png, ...
      meta_data_websight.json
      meta_data_websight_100k.json
"""
    )
